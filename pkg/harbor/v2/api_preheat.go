...
func (a *PreheatApiService) CreateInstance(ctx context.Context, instance Instance, localVarOptionals *PreheatApiCreateInstanceOpts) (InstanceCreatedResp, *http.Response, error) {
	var (
...
func (a *PreheatApiService) UpdateInstance(ctx context.Context, preheatInstanceName string, instance Instance, localVarOptionals *PreheatApiUpdateInstanceOpts) (InstanceUpdateResp, *http.Response, error) {
	var (
