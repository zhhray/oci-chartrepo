...
*/
func (a *RetentionApiService) RetentionsIdExecutionsEidPatch(ctx context.Context, id int64, eid int64, action Action1) (*http.Response, error) {
	var (
 ...
 * @param id Retention ID.
 * @param eid Retention execution ID.
 * @param optional nil or *RetentionApiRetentionsIdExecutionsEidTasksGetOpts - Optional Parameters:
...
type RetentionApiRetentionsIdExecutionsEidTasksGetOpts struct { 
	Page optional.Int32
	PageSize optional.Int32
}

func (a *RetentionApiService) RetentionsIdExecutionsEidTasksGet(ctx context.Context, id int64, eid int64, localVarOptionals *RetentionApiRetentionsIdExecutionsEidTasksGetOpts) ([]RetentionExecutionTask, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Retention ID.
 * @param optional nil or *RetentionApiRetentionsIdExecutionsGetOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  The page number.
     * @param "PageSize" (optional.Int32) -  The size of per page.
...
type RetentionApiRetentionsIdExecutionsGetOpts struct { 
	Page optional.Int32
	PageSize optional.Int32
}

func (a *RetentionApiService) RetentionsIdExecutionsGet(ctx context.Context, id int64, localVarOptionals *RetentionApiRetentionsIdExecutionsGetOpts) ([]RetentionExecution, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *RetentionApiService) RetentionsIdExecutionsPost(ctx context.Context, id int64, action Action) (*http.Response, error) {
	var (
...
*/
func (a *RetentionApiService) RetentionsPost(ctx context.Context, policy RetentionPolicy) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
